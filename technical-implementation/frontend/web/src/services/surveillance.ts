...
export function createSurveillanceReport(
  ...
  return apiRequest<SurveillanceReport>("/surveillance/", {
    method: "POST",
    token,
...
export function getSurveillanceReport(token: string, reportId: string) {
  return apiRequest<SurveillanceReport>(`/surveillance/${reportId}/`, {
    method: "GET",
    token,
  });
}
...
export function listSurveillanceFollowUps(token: string, reportId: string) {
  return apiRequest<FollowUpAction[]>(
    `/surveillance/${reportId}/follow-ups`,
    {
      method: "GET",
      token,
    },
...
export function createSurveillanceFollowUp(
  ...
  return apiRequest<FollowUpAction>(`/surveillance/${reportId}/follow-ups`, {
    method: "POST",
    token,
    body: JSON.stringify(payload),
  });
